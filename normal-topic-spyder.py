...
def spider(username,password,driver,book_name_xls,sheet_name_xls,keyword,maxWeibo):
    ...
    time.sleep(2)
    name = keyword
    shishi_element = driver.find_element_by_xpath("//*[@id='app']/div[1]/div[1]/div[3]/div[2]/div[1]/div/div/div/ul/li[2]/span")
...
if __name__ == '__main__':
    ...
    keywords = ["#华为向武汉捐赠3000万#",] # 此处可以设置多个话题，#必须要加上
